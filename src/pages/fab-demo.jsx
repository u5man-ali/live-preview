...
<p className="w-full h-min text-body-md text-neutral-hovered font-normal mb-4 ">Whether launching a creation flow, triggering contextual tools, or prompting a new message, the FAB makes your intent unmistakable—without overwhelming the layout.</p>
        <div className="text-neutral-hovered w-full border border-neutral-regular rounded-curve-xl justify-center items-center px-6 py-8 flex flex-wrap gap-4">
          Basic FAB
          <FAB
          size="md"
          style="primary"
        ...
        <p className="w-full h-min text-body-md text-neutral-hovered font-normal">Each variant and style of the FAB corresponds with that of the default button component and is identical in this context. So here are a few examples of the FAB variants.</p>
        <div className="text-neutral-hovered w-full border border-neutral-regular rounded-curve-xl justify-center items-center px-6 py-8 flex flex-wrap gap-4">
          Gradient FAB
          <FAB
          size="md"
        ...
        <p className="w-full h-min text-body-md text-neutral-hovered font-normal">Each color option is tuned for accessibility and clarity, making it easy to signal different types of actions.</p>
        <div className="text-neutral-hovered w-full border border-neutral-regular rounded-curve-xl justify-center items-center px-6 py-8 flex flex-wrap gap-4">
          Brand Primary
          <FAB
          size="md"
        ...
        <p className="w-full h-min text-body-md text-neutral-hovered font-normal">The Floating Action Button pairs beautifully with cards, modals, drawers, and other DC components. Whether you're building a productivity tool, admin dashboard, or mobile-first app, the FAB anchors your UI with functional flair.</p>
        <div className="text-neutral-hovered w-full border border-neutral-regular rounded-curve-xl justify-center items-center px-6 py-8 flex flex-wrap gap-4">
          Rounded Corners
          <FAB
          size="md"
        ...
        <p className="w-full h-min text-body-md text-neutral-hovered font-normal">Identical to the DC Button component, FABs also feature 3 distinct size variants for different use cases.</p>
        <div className="text-neutral-hovered w-full border border-neutral-regular rounded-curve-xl justify-center items-center px-6 py-8 flex flex-wrap gap-4">
          Small FAB
          <FAB
          size="sm"
