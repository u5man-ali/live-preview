...
export default function buttonDemo() {
  return (
    <div className="flex justify-center items-center gap-4 mb-4 flex-wrap ">
        ...
        <p className="w-full h-min text-body-md text-neutral-900 font-normal">The DC Button is a versatile, fully responsive UI element crafted with Tailwind CSS, ideal for building modern interfaces that demand clarity and performance. Whether you're designing a compelling call-to-action, form submission flow, or navigation control, this component delivers flexibility, consistency, and polish across devices and use cases.
...
<p className="w-full h-min text-body-md text-neutral-900 font-normal mb-4 ">Explore the variations below to understand its full potential and how you can integrate it effortlessly into your Tailwind-based projects.</p>
        <h3 className="w-full h-min text-body-lg font-semibold">Button</h3>
        <p className="w-full h-min text-body-md text-neutral-900 font-normal">This is the foundational version of the DC Button, featuring a clean layout with a primary color palette and a subtle gradient style along with it's disabled (muted) version. Interactive states like hover and active transitions provide smooth feedback to enhance user experience. It’s perfect for general use across dashboards, forms, and utility actions.</p>
        ...
        <p className="w-full h-min text-body-md text-neutral-900 font-normal">DC Button supports a rich set of visual styles to suit different interaction goals:</p>
        <p className="w-full h-min text-body-md text-neutral-900 font-normal">
        ...
        <p className="w-full h-min text-body-md text-neutral-900 font-normal">Each style is built with consistency and accessibility in mind, ensuring that your design remains clean and intuitive.</p>
        <div className="w-full border border-white-600 rounded-curve-xl justify-center items-center px-6 py-8 flex flex-wrap gap-4">
          <Button
          size="md"
          style="secondary"
        ...
        <p className="w-full h-min text-body-md text-neutral-900 font-normal">Buttons can include left or right icons, enhancing clarity and visual meaning. Common examples include:</p>
        <p className="w-full h-min text-body-md text-neutral-900 font-normal">
        ...
        <p className="w-full h-min text-body-md text-neutral-900 font-normal">Icons can be customized in size and style, and you can toggle their presence based on your layout needs.</p>
        <div className="w-full border border-white-600 rounded-curve-xl justify-center items-center px-6 py-8 flex flex-wrap gap-4">
          <Button
          size="sm"
          style="info"
        ...
        <p className="w-full h-min text-body-md text-neutral-900 font-normal">The DC Button supports contextual color schemes to communicate intent:</p>
        <p className="w-full h-min text-body-md text-neutral-900 font-normal">
        ...
        <p className="w-full h-min text-body-md text-neutral-900 font-normal">Each color option is tuned for accessibility and clarity, making it easy to signal different types of actions.</p>
        <div className="w-full border border-white-600 rounded-curve-xl justify-center items-center px-6 py-8 flex flex-wrap gap-4">
          <Button
          size="md"
          style="primary"
        ...
        <p className="w-full h-min text-body-md text-neutral-900 font-normal">Chosse from multiple shapes to align with your UI's tone and purpose:</p>
        <p className="w-full h-min text-body-md text-neutral-900 font-normal">
        ...
        <p className="w-full h-min text-body-md text-neutral-900 font-normal">This flexibility lets you match the design language of your app or brand</p>
        <div className="w-full border border-white-600 rounded-curve-xl justify-center items-center px-6 py-8 flex flex-wrap gap-4">
          <Button
          size="md"
          style="primary"
        ...
        <p className="w-full h-min text-body-md text-neutral-900 font-normal">DC Button supports three standard sizes:</p>
        <p className="w-full h-min text-body-md text-neutral-900 font-normal">
