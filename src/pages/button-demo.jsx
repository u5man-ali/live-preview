...
<p className="w-full h-min text-body-md text-neutral-hovered font-normal mb-4 ">Explore the variations below to understand its full potential and how you can integrate it effortlessly into your Tailwind-based projects.</p>
        ...
        <p className="w-full h-min text-body-md text-neutral-hovered font-normal">Each style is built with consistency and accessibility in mind, ensuring that your design remains clean and intuitive.</p>
        <div className="w-full border border-neutral-regular rounded-curve-xl justify-center items-center px-6 py-8 flex flex-wrap gap-4">
          <Button
          size="md"
          style="secondary"
        ...
        <p className="w-full h-min text-body-md text-neutral-default font-normal">Icons can be customized in size and style, and you can toggle their presence based on your layout needs.</p>
        <div className="w-full border border-neutral-regular rounded-curve-xl justify-center items-center px-6 py-8 flex flex-wrap gap-4">
          <Button
          size="sm"
          style="info"
        ...
        <p className="w-full h-min text-body-md text-neutral-hovered font-normal">This flexibility lets you match the design language of your app or brand</p>
        <div className="w-full border border-neutral-regular rounded-curve-xl justify-center items-center px-6 py-8 flex flex-wrap gap-4">
          <Button
          size="md"
          style="primary"
